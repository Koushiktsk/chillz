...
const Blueberry = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-600 to-blue-300 text-white">
      <Navbar />
      <div className="flex flex-col md:flex-row items-center justify-between px-10 py-10">
        ...
        <div className="mt-10 md:mt-0">
          <img src="/blueberry_big.png" alt="Blueberry Cone" className="w-[380px] mt-6" onClick={() => navigate('/vanilla')}/>
        </div>
      </div>
    </div>
  );
