...
const Strawberry = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-pink-600 to-pink-300 text-white">
      <Navbar />
      <div className="flex flex-col md:flex-row items-center justify-between px-10 py-10">
        ...
        <div className="mt-10 md:mt-0">
          <img src="/strawberry_big.png" alt="Strawberry Cone" className="w-[400px] mt-6" onClick={() => navigate('/blueberry')} />
        </div>
      </div>
    </div>
  );
